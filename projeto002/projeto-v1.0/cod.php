...
<head>
    ...
    <link rel="stylesheet" href="estilos/Proficional.css">
    <style>
        h1 {
            text-align: center;
            font-size: 1.9rem;
    ...
    <div class="container">
        ...
        # VERIFICAR SE É PA
            ...
            # VERIFICAR A MONOTONIA
                if ($r1 == 0){
                    printf("<p>A <strong>MONOTONIA</strong> DOS NUM DA SUCESSÃO É <strong>CONSTANTE R = 0</strong></p>");
                } else if ($r1 > 0){
                    printf("<p>A <strong>MONOTONIA</strong> DOS NUM DA SUCESSÃO É CRESCENTE R > 0</p>");
                } else {
                    printf("<p>A <strong>MONOTONIA</strong> DOS NUM DA SUCESSÃO É <strong>DECRESCENTE R < 0</strong></p>");
                }

                if ($r2 == 0){
                    printf("<p>A <strong>MONOTONIA</strong> DOS DENO DA SUCESSÃO É <strong>CONSTANTE R = 0</strong></p>");
                } else if ($r2 > 0){
                    printf("<p>A <strong>MONOTONIA</strong> DOS DENO DA SUCESSÃO É <strong>CRESCENTE R > 0</strong></p>");
                } else {
                    printf("<p>A <strong>MONOTONIA</strong> DOS DENO DA SUCESSÃO É <strong>DECRESCENTE R < 0</strong></p>");
                }
